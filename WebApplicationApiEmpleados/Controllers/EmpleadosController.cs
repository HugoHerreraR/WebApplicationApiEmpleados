...
namespace WebApplicationApiEmpleados.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmpleadosController : ControllerBase
    {
        private readonly WebApplicationApiEmpleadosContext _context;

        public EmpleadosController(WebApplicationApiEmpleadosContext context)
        {
            _context = context;
        }
